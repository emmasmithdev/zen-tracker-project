<template lang="html">
  <div class="component">
      <div class="wrapper">
          <h2>Your score was {{callCalculator(footprint)}} Thunbergs!</h2>
        <div class="yourscore">
          <img v-for="image in callCalculator(footprint)" src="https://www.biography.com/.image/t_share/MTY4MDk3MDc5NjQ0NjYxMDA5/greta-thunberg-looks-on-during-a-meeting-in-the-garden-of-the-hotel-de-lassay-ahead-of-a-visit-of-the-french-national-assembly-in-paris-photo-credit-should-read-lionel-bonaventureafp-via-getty-imagesj.jpg" alt="happy greta">
        </div>
        <div class="sentences">
          ...
          <p v-else>You don't recycle. You would be cooler if you recyled more and composted your food waste. (Recycled aluminium cans use 1/12th of the energy of a newly mined and manufactured one.)</p>
